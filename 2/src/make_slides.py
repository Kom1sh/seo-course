...
# 03 план
S.append(slide(top("План на сегодня") + '<h1>От запросов к карте сайта и блогу: шесть шагов за полтора часа</h1>'
  '<div class="body"><div class="pipe six" style="margin:auto 0">'
  + step("1", "Спрос", "12 минут. Частотность, намерение, время в запросах.", "", "gauge", 0) + arrow()
  + step("2", "Где брать", "12 минут. Подсказки, Вордстат, свой Вебмастер, сервисы.", "", "search", 1) + arrow()
  + step("3", "Кластеры", "12 минут. Что выкинуть и как понять, одна страница или две.", "", "layers", 2) + arrow()
  + step("4", "Структура", "20 минут. Дерево, посадочные, перелинковка, сироты.", "", "sitemap", 3) + arrow()
  + step("5", "Блог", "14 минут. Зачем он, типы статей, как писать, ИИ.", "", "doc", 4) + arrow()
...
CHECK = [("Одному кластеру — одна страница", "Нет двух страниц под одно намерение."),
         ...
         ("Ни одной сироты", "У каждой страницы минимум два входа: хаб и соседняя страница или статья.")]
